...
cd $DEV/gobierto-etl-utils/current/; ruby operations/download/run.rb "https://do.diba.cat/api/dataset/tercers/token/98e0ab9462ee6b20427441dbab8426b9/pag-fi/999999/camp-exercici/2017" /tmp/diba/providers_2017.json

# Extract > Check JSON format
cd $DEV/gobierto-etl-utils/current/; ruby operations/check-json/run.rb /tmp/diba/providers_2015.json
cd $DEV/gobierto-etl-utils/current/; ruby operations/check-json/run.rb /tmp/diba/providers_2016.json
...
cd $DEV/gobierto-etl-diba/current/; ruby operations/gobierto_budgets/transform-providers/run.rb /tmp/diba/providers_2016.json /tmp/diba/providers_2016_transformed.json
cd $DEV/gobierto-etl-diba/current/; ruby operations/gobierto_budgets/transform-providers/run.rb /tmp/diba/providers_2017.json /tmp/diba/providers_2017_transformed.json

# Load > Import invoices
for file in /tmp/diba/*_transformed.json; do
  cd $DEV/gobierto-etl-utils/current/; ruby operations/gobierto_budgets/import-invoices/run.rb $file
done
