...
cd $DEV/gobierto-etl-utils/current/; ruby operations/download/run.rb "https://do.diba.cat/api/dataset/ingressos/token/98e0ab9462ee6b20427441dbab8426b9/pag-fi/999999/camp-instantania/2018-12" /tmp/diba/budgets-2018-income.json
cd $DEV/gobierto-etl-utils/current/; ruby operations/download/run.rb "https://do.diba.cat/api/dataset/ingressos/token/98e0ab9462ee6b20427441dbab8426b9/pag-fi/999999/camp-instantania/2019-1" /tmp/diba/budgets-2019-income.json
...
cd $DEV/gobierto-etl-utils/current/; ruby operations/download/run.rb "https://do.diba.cat/api/dataset/despeses/token/98e0ab9462ee6b20427441dbab8426b9/pag-fi/999999/camp-instantania/2018-12"  /tmp/diba/budgets-2018-expenses.json
cd $DEV/gobierto-etl-utils/current/; ruby operations/download/run.rb "https://do.diba.cat/api/dataset/despeses/token/98e0ab9462ee6b20427441dbab8426b9/pag-fi/999999/camp-instantania/2019-1"  /tmp/diba/budgets-2019-expenses.json
...
cd $DEV/gobierto-etl-utils/current/; ruby operations/check-json/run.rb /tmp/diba/budgets-2019-income.json
...
cd $DEV/gobierto-etl-utils/current/; ruby operations/check-json/run.rb /tmp/diba/budgets-2019-expenses.json


# Load > Remove previous data
cd $DEV/gobierto-etl-utils/current/; ruby operations/gobierto_budgets/clear-budgets/run.rb /tmp/diba/organization_id.txt
...
cd $DEV/gobierto/current/; bin/rails runner $DEV/gobierto-etl-diba/current/operations/gobierto_budgets/import-budgets/run.rb /tmp/diba/budgets-2019-income.json 2019
...
cd $DEV/gobierto/current/; bin/rails runner $DEV/gobierto-etl-diba/current/operations/gobierto_budgets/import-budgets/run.rb /tmp/diba/budgets-2019-expenses.json 2019

# Load > Calculate totals
cd $DEV/gobierto-etl-utils/current/; ruby operations/gobierto_budgets/update_total_budget/run.rb "2015 2016 2017 2018 2019" /tmp/diba/organization_id.txt
...
cd $DEV/gobierto/current/; bin/rails runner $DEV/gobierto-etl-utils/current/operations/gobierto_budgets/annual_data/run.rb "2015 2016 2017 2018 2019" /tmp/diba/organization_id.txt
