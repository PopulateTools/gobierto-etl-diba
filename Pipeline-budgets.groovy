...
pipeline {
    ...
    stages {
        stage('Extract > Download data sources') {
            steps {
                sh "cd ${GOBIERTO_ETL_UTILS}; ruby operations/download/run.rb 'https://do.diba.cat/api/dataset/ingressos/token/98e0ab9462ee6b20427441dbab8426b9/pag-fi/999999/camp-instantania/2015-12' ${WORKING_DIR}/budgets-2015-income.json"
                ...
                sh "cd ${GOBIERTO_ETL_UTILS}; ruby operations/download/run.rb 'https://do.diba.cat/api/dataset/ingressos/token/98e0ab9462ee6b20427441dbab8426b9/pag-fi/999999/camp-instantania/2018-5'  ${WORKING_DIR}/budgets-2018-income.json"
                sh "cd ${GOBIERTO_ETL_UTILS}; ruby operations/download/run.rb 'https://do.diba.cat/api/dataset/despeses/token/98e0ab9462ee6b20427441dbab8426b9/pag-fi/999999/camp-instantania/2015-12'  ${WORKING_DIR}/budgets-2015-expenses.json"
                ...
                sh "cd ${GOBIERTO_ETL_UTILS}; ruby operations/download/run.rb 'https://do.diba.cat/api/dataset/despeses/token/98e0ab9462ee6b20427441dbab8426b9/pag-fi/999999/camp-instantania/2018-5'   ${WORKING_DIR}/budgets-2018-expenses.json"
            }
        }
        stage('Extract > Check JSON format') {
            steps {
                sh "cd ${GOBIERTO_ETL_UTILS}; ruby operations/check-json/run.rb ${WORKING_DIR}/budgets-2015-income.json"
                ...
                sh "cd ${GOBIERTO_ETL_UTILS}; ruby operations/check-json/run.rb ${WORKING_DIR}/budgets-2018-income.json"
                sh "cd ${GOBIERTO_ETL_UTILS}; ruby operations/check-json/run.rb ${WORKING_DIR}/budgets-2015-expenses.json"
                ...
                sh "cd ${GOBIERTO_ETL_UTILS}; ruby operations/check-json/run.rb ${WORKING_DIR}/budgets-2018-expenses.json"
            }
        }
        ...
        stage('Load > Import income data') {
            steps {
              sh "cd ${GOBIERTO}; bin/rails runner ${DIBA_ETL}/operations/gobierto_budgets/import-budgets/run.rb ${WORKING_DIR}/budgets-2015-income.json 2015"
              ...
              sh "cd ${GOBIERTO}; bin/rails runner ${DIBA_ETL}/operations/gobierto_budgets/import-budgets/run.rb ${WORKING_DIR}/budgets-2018-income.json 2018"
            }
        }
        stage('Load > Import expenses data') {
            steps {
              sh "cd ${GOBIERTO}; bin/rails runner ${DIBA_ETL}/operations/gobierto_budgets/import-budgets/run.rb ${WORKING_DIR}/budgets-2015-expenses.json 2015"
              ...
              sh "cd ${GOBIERTO}; bin/rails runner ${DIBA_ETL}/operations/gobierto_budgets/import-budgets/run.rb ${WORKING_DIR}/budgets-2018-expenses.json 2018"
            }
        }
