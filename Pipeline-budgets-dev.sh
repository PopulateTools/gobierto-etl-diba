...
cd $DEV/gobierto-etl-utils/; ruby operations/download/run.rb "https://do.diba.cat/api/dataset/ingressos/token/98e0ab9462ee6b20427441dbab8426b9/pag-fi/999999/camp-instantania/2018-5" /tmp/diba/budgets-2018-income.json
cd $DEV/gobierto-etl-utils/; ruby operations/download/run.rb "https://do.diba.cat/api/dataset/despeses/token/98e0ab9462ee6b20427441dbab8426b9/pag-fi/999999/camp-instantania/2015-12"  /tmp/diba/budgets-2016-expenses.json
...
cd $DEV/gobierto-etl-utils/; ruby operations/download/run.rb "https://do.diba.cat/api/dataset/despeses/token/98e0ab9462ee6b20427441dbab8426b9/pag-fi/999999/camp-instantania/2018-5"  /tmp/diba/budgets-2018-expenses.json
...
cd $DEV/gobierto; bin/rails runner $DEV/gobierto-etl-diba/operations/gobierto_budgets/import-budgets/run.rb /tmp/diba/budgets-2016-income.json 2015
...
cd $DEV/gobierto; bin/rails runner $DEV/gobierto-etl-diba/operations/gobierto_budgets/import-budgets/run.rb /tmp/diba/budgets-2017-income.json 2017
cd $DEV/gobierto; bin/rails runner $DEV/gobierto-etl-diba/operations/gobierto_budgets/import-budgets/run.rb /tmp/diba/budgets-2017-income.json 2018

# Load > Import expenses data
cd $DEV/gobierto; bin/rails runner $DEV/gobierto-etl-diba/operations/gobierto_budgets/import-budgets/run.rb /tmp/diba/budgets-2016-expenses.json 2015
...
cd $DEV/gobierto; bin/rails runner $DEV/gobierto-etl-diba/operations/gobierto_budgets/import-budgets/run.rb /tmp/diba/budgets-2017-expenses.json 2018

# Load > Calculate totals
echo "diba" > /tmp/diba/organization_id.txt
cd $DEV/gobierto-etl-utils/; ruby operations/gobierto_budgets/update_total_budget/run.rb "2015 2016 2017 2018" /tmp/diba/organization_id.txt
...
cd $DEV/gobierto/; bin/rails runner $DEV/gobierto-etl-utils/operations/gobierto_budgets/annual_data/run.rb "2015 2016 2017 2018" /tmp/diba/organization_id.txt
